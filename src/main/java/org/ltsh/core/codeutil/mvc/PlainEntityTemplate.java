 ...
 * 2018年4月28日
 */
public class PlainEntityTemplate extends TemplateBuilder{
	
	public PlainEntityTemplate(String rootPath, String packagePath) {
	...
	public Object getModel(DBTable table) {
		...
		for(DBTableColumn f : table.getColumns()){
			...
			curField.put("fieldComment", f.getComment());
